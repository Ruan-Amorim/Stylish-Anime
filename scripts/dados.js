...
export const ArrayInfoAnimes = {
    "Boku no Hero": {
        "image_capa": "midias/image/Boku no Hero/image_capa.jpg",
        "nome_capa": "Boku no Hero",
        "nome_anime": "Boku no Hero: Academia",
        "estrou": "Estreou: Primavera 2016",
        "fonte": "Fonte: Mangá",
        "genero": "Gêneros: Ação",
        "temas": "Temas: Escola, Super Poder",
        "produtores": "Produtores: Dentsu, Mainchi Broadcasting, System, Movic, Animação TOHO, Shueisha",
        "estudios": "Estúdios: Bones",
        "titulo": "Boku no Hero: Academia",
        "sinopse": 'Boku no Hero Academia segue Izuku Midoriya, um garoto que vive em um mundo onde quase todos têm superpoderes conhecidos como "quirks". Nascido sem um poder, ele é determinado a se tornar um herói. Após um encontro com o maior herói do mundo, Midoriya ganha um poder especial e entra para a U.A. High School para treinar e se tornar um herói verdadeiro.<br><br>Enquanto enfrenta desafios e vilões, Midoriya desenvolve suas habilidades e forma laços com colegas de classe. A série explora temas de heroísmo, amizade e a jornada de um jovem em busca de seu lugar em um mundo cheio de poderes.',
        "score": "7.86",
        "users": "2.090.341 users",
        "image_protagonista": "midias/image/Boku no Hero/image_prota.jpeg",
        "nome_protagonista": "Midoriya",
        "texto_protagonista": 'Izuku Midoriya é o dedicado protagonista de "Boku no Hero Academia". Nascido sem um "quirk" em um mundo cheio de superpoderes, ele é um exemplo de coragem e perseverança. Sua empatia e altruísmo o destacam, e seu desejo de se tornar um herói é alimentado por um forte senso de moralidade e justiça. Midoriya enfrenta suas próprias limitações com uma determinação implacável, revelando um caráter que combina vulnerabilidade e força, em sua jornada para se tornar um herói verdadeiro.',
    },
    "Re: Zero": {
        "image_capa": "midias/image/Re Zero/image_capa.jpg",
        "nome_capa": "Re: Zero",
        "nome_anime": "Re: Zero Kara Hajimeru Isekai Seikatsu",
        "estrou": "Estreou: Primavera de 2016",
        "fonte": "Fonte: light Novel",
        "genero": "Gêneros: Drama, Fanstasia, Suspense",
        "temas": "Temas: Isekai, Psicológico, Viagem no Tempo",
        "produtores": "Produtores: TV Tokyo, Media Factory, Kadokawa, Shoten, AT-X, Magic Capsule, Hakuhodo DY Music & Pictures",
        "estudios": "Estúdios: White Fox",
        "titulo": "Re: Zero Kara Hajimeru Isekai Seikatsu",
        "sinopse": "Re: Zero é um anime que segue Subaru Natsuki, um jovem que é misteriosamente transportado para um mundo de fantasia. Sem habilidades especiais, ele descobre que possui o poder de retornar no tempo ao morrer. Ao fazer novos amigos e enfrentar perigos, Subaru busca uma forma de usar seu poder para proteger aqueles que ama e resolver os desafios que surgem.<br><br>Enquanto Subaru se adapta a este novo mundo, ele enfrenta uma série de mortes dolorosas e eventos trágicos. Ele deve lidar com traumas emocionais e desenvolver alianças para superar inimigos poderosos e desvendar os segredos de seu novo destino.",
        "score": "8.23",
        "users": "1.427.221 users",
        "image_protagonista": "midias/image/Re Zero/image_prota.jpeg",
        "nome_protagonista": "Subaru",
        "texto_protagonista": 'Subaru Natsuki é o complexo protagonista de "Re: Zero". Inicialmente um jovem comum, ele é transportado para um mundo de fantasia onde descobre ter o poder de voltar no tempo após a morte. Esse dom é uma bênção e uma maldição, pois Subaru enfrenta desafios emocionais e físicos enquanto tenta proteger aqueles ao redor. Sua determinação e crescimento pessoal são destacados pela sua luta para equilibrar medos e responsabilidades, revelando um caráter profundo e multifacetado.',
    },
    "Black Clover": {
        "image_capa": "midias/image/Black Clover/image_capa.jpg",
        "nome_capa": "Black Clover",
        "nome_anime": "Black Clover",
        "estrou": "Estreou: Outono 2017",
        "fonte": "Fonte: Mangá",
        "genero": "Gêneros: Açao, Comédia, Fantasia, Shounen",
        "temas": "Temas: Magia",
        "produtores": "Produtores: TV Tokyo, Avex Pictures, Shueisha Funimation, Crunchyroll",
        "estudios": "Estúdios: Pierrot",
        "titulo": "Black Clover",
        "sinopse": "Black Clover é um anime que acompanha Asta e Yuno, dois órfãos em um mundo onde a magia é tudo. Enquanto Yuno demonstra talentos mágicos impressionantes, Asta luta com a falta de habilidades mágicas. Ambos aspiram a se tornar o Wizard King, o maior mago do reino. Através de treinamento intenso e determinação, eles enfrentam desafios e inimigos para alcançar seus sonhos.<br><br>Com o tempo, Asta descobre que possui um poder raro que pode mudar seu destino. Juntos, ele e Yuno se enfrentam a adversidades e formam laços com outros magos, enquanto revelam segredos sobre o mundo mágico e buscam superar suas próprias limitações.",
        "score": "8.14",
        "users": "870.986 users",
        "image_protagonista": "midias/image/Black Clover/image_prota.jpeg",
        "nome_protagonista": "Asta",
        "texto_protagonista": 'Asta é o carismático protagonista de "Black Clover". Sem um "quirk" mágico, ele se destaca pela determinação inabalável e força física. Sua personalidade otimista e positiva contrasta com a falta de habilidades mágicas, e ele luta incessantemente para se tornar Wizard King. Asta é impulsionado por um forte senso de justiça e amizade, e sua jornada é marcada pela busca incessante por superação e autoafirmação, revelando uma personalidade resiliente e inspiradora.',
    },
    "Dr. Stone": {
        "image_capa": "midias/image/Dr. Stone/image_capa.jpg",
        "nome_capa": "Dr. Stone",
        "nome_anime": "Nome: Dr. Stone",
        "estrou": "Estreou: Inverno 2021",
        "fonte": "Fonte: Mangá",
        "genero": "Gêneros: Aventura, Comédia, Ficção Científica",
        "temas": "Temas: Sobrevivência",
        "produtores": "Produtores: Animação TOHO, Shueisha, Toho Music, 8PAN",
        "estudios": "Estúdios: Entreterimento TMS",
        "titulo": "Dr. Stone",
        "sinopse": "Dr. Stone é um anime que se passa após um mistério global transformar a humanidade em pedra. Senku Ishigami, um jovem cientista, acorda milhares de anos depois e decide reconstruir a civilização com base na ciência. Usando seu conhecimento, ele começa a avançar a tecnologia a partir do zero e busca reviver a humanidade.<br><br>Enquanto Senku enfrenta desafios e inimigos, ele constrói uma nova sociedade e desvenda os segredos por trás do fenômeno que petrificou a população. A série explora temas de inovação científica e a luta pela sobrevivência em um mundo pós-apocalíptico.",
        "score": "8.16",
        "users": "603.740 users",
        "image_protagonista": "midias/image/Dr. Stone/image_prota.jpeg",
        "nome_protagonista": "Senku",
        "texto_protagonista": 'Senku Ishigami é o inovador protagonista de "Dr. Stone". Após um fenômeno que petrifica a humanidade, Senku acorda para reconstruir a civilização com base na ciência. Ele possui uma mente brilhante e um entusiasmo contagiante pela pesquisa e descobertas científicas. Senku é movido por uma paixão profunda pela ciência e um desejo de reconstruir a sociedade, mostrando uma personalidade vibrante e determinada que enfrenta desafios com criatividade e inovação.',
    },
    "Jujutsu Kaisen": {
    ...
    "Isekai de Cheat Skill": {
        ...
        "nome_capa": "Isekai de Cheat Skill",
